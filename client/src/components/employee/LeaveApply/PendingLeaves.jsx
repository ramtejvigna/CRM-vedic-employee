...
const PendingLeaves = ({
  ...
  <TableRow>
    <TableCell className="px-6 py-2 text-left text-lg font-bold text-gray-700 dark:text-gray-300  tracking-wider">
      S.No
    </TableCell>
    <TableCell className="px-6 py-3 text-left text-lg font-bold text-gray-700 dark:text-gray-300  tracking-wider">
      Leave Type
    </TableCell>
    <TableCell className="px-6 py-3 text-left text-lg font-bold text-gray-700 dark:text-gray-300  tracking-wider">
      From
    ...
    <TableCell className="px-6 py-3 text-left text-lg font-bold text-gray-700 dark:text-gray-300  tracking-wider">
      ...
      <Transition appear show={deleteConfirmationOpen} as={Fragment}>
        <Dialog as="div" className="relative z-50" onClose={() => setDeleteConfirmationOpen(false)}>
          <Transition.Child
            as={Fragment}
            enter="ease-out duration-300"
            enterFrom="opacity-0"
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-end gap-2 pt-4">
                        ...
                        <button
                          ...
                          className="inline-flex items-center px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
                        >
                          Delete
                        </button>
                      </div>
