...
const NotificationButton = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await axios.get(`https://vedic-backend-neon.vercel.app/api/notifications/get`, {
  ...
  const markAsRead = async (id) => {
    try {
      await axios.put(`https://vedic-backend-neon.vercel.app/api/notifications/${id}/read`, {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
      fetchNotifications();
    } catch (error) {
